<template>
	<div style="position: relative;padding: 20px;">
		...
		<div style="text-align: center;font-size: 28px;text-align: center;padding-top: 50px;font-weight: 700;" :span="24">
			{{formParams.formName}}
		</div>
...
<script>
	...
	export default {
			...
			submitFormData(){
				...
				for(let key in this.formData){
					...
					if(this.formDesc[key].type=='radio'){
						...
						htmlType = "array"
					}else if(this.formDesc[key].type=='date'){
						htmlType = "datetime"
					}else{
						htmlType = "string"
					}
		...
		mounted() {
			this.formParams = this.$route.params.formParams
			this.getFormDetail()
		}
	}
</script>
